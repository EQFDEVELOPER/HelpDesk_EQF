<?php
// /HelpDesk_EQF/modules/dashboard/admin/ajax/equipment_detail.php
session_start();
...
try {
  ...
  // Nombre de admin que marcó envío (si existe)
  $shippedBy = '';
  ...
  // Nombre de usuario que marcó entregado (si existe)
  $deliveredBy = '';
  ...
  <div class="task-card">
    ...
    <div class="panel-mini-note">
      ...
      <?php if (!empty($req['requester_name'])): ?>
        · <?php echo h($req['requester_name']); ?>
      <?php endif; ?>
      <?php if (!empty($req['requester_area'])): ?>
        · <?php echo h($req['requester_area']); ?>
      <?php endif; ?>
    </div>
