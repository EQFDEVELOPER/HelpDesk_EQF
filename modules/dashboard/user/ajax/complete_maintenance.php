...
try {
    ...
    // ==========================================================================
    // 1. OBTENER EL USER_ID DEL SOLICITANTE ORIGINAL (Para asociar su encuesta)
    // ==========================================================================
    ...
    // ==========================================================================
    // 2. GENERAR UN TOKEN ÚNICO Y SEGURO PARA LA TABLA MAINTENANCE_FEEDBACK
    // ==========================================================================
    $feedbackToken = bin2hex(random_bytes(32));

    // ==========================================================================
    // 3. ACTUALIZAR SOLICITUD: SOLO CAMBIAMOS EL ESTATUS A FINALIZADO
    // ==========================================================================
    ...
    echo json_encode([
        'ok' => true, 
        'msg' => '¡Mantenimiento cerrado y registrado de manera exitosa! Encuesta activada.'
    ]);
